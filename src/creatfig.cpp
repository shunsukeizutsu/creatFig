...
void PlotData::PrintFig2D(int gShutOff) // vector->２次元で一つのグラフ生成
{
...
void PlotData::PrintFig2Dx2(int gShutOff) // vector->２次元で2つのグラフ生成
{
    fprintf(gp, "p ");
...
void PlotData::PrintFig2Dx3(int gShutOff) // vector->２次元で3つのグラフ生成
{
...
void PlotData::PrintFig3D(int gShutOff) // vector->２次元で一つのグラフ生成
{
    fprintf(gp, "splot ");
    fprintf(gp, " '-' pt 7 ps 1 lc rgb 'red' t \"\" ");
    for (int i = 0; i < Vdata.size(); i++)
